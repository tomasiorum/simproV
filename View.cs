...
namespace SimproV
{
    public class View
    {
        ...
        public delegate void SolicitacaoListaFaturas(ref List<Fatura> listaFaturas);
        ...
        public void CliqueEmListaFaturas(object origem, EventArgs e)
        {
